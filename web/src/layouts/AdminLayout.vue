...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      // The catalogue of hardcoded exit interview forms — read-only; each
      // department is pointed at one on the Departments page.
      { label: 'Exit Interview', to: '/admin/exit-interviews', badge: '', icon: 'exit' },
    ],
  },
  {
    heading: 'System',
      ...
      <nav class="flex-1 overflow-y-auto px-3 py-2">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="h-5 w-5 shrink-0">
            ...
            <path v-if="item.icon === 'book'" d="M12 6.5c-1.4-1-3.6-1.5-6-1.5-.6 0-1 .4-1 1v11c0 .6.4 1 1 1 2.4 0 4.6.5 6 1.5 1.4-1 3.6-1.5 6-1.5.6 0 1-.4 1-1V6c0-.6-.4-1-1-1-2.4 0-4.6.5-6 1.5Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" />
            <path v-if="item.icon === 'book'" d="M12 6.5V19" stroke="currentColor" stroke-width="1.6" />
            ...
            <circle v-if="item.icon === 'gear'" cx="12" cy="12" r="2.6" stroke="currentColor" stroke-width="1.6" />
            <path
              v-if="item.icon === 'gear'"
              d="M12 4.5v1.6M12 17.9v1.6M19.5 12h-1.6M6.1 12H4.5M17.5 6.5l-1.1 1.1M7.6 16.4l-1.1 1.1M17.5 17.5l-1.1-1.1M7.6 7.6 6.5 6.5"
              stroke="currentColor"
              stroke-width="1.6"
