...
const navItems = [
  ...
  { label: 'Journal Calendar', to: '/student/calendar', badge: '' },
...
<template>
  <div class="min-h-screen bg-slate-100 text-slate-800">
      ...
      <div class="border-t border-blue-400 p-3">
        <div class="mb-3 flex items-center gap-3 px-3 py-2">
          ...
          <div class="min-w-0">
            ...
            <p class="truncate text-xs text-blue-100">Student - {{ department }}</p>
          </div>
        </div>
        <button
          type="button"
    ...
    <div class="ml-64 min-h-screen">
      <header class="sticky top-0 z-10 flex h-16 items-center border-b border-slate-200 bg-white px-8">
